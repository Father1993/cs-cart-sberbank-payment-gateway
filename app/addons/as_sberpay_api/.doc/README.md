...
> **Для AI-агентов и разработки**: полная структурированная документация API (карта, SberPay, СБП, новый/старый API) — см. **[sber-docs.md](sber-docs.md)**.
...
│   ├── sber-docs.md                   # Полная API-документация (для AI и разработки)
│   ├── API.md                         # Описание API Сбера (методы, форматы, справочники)
